...
//
//        // 作输出选择
//        WC.SwitchMethod(s,f,path,isDirectory);
...
//        File f = new File("e:/develop/theme/My_wc");
//        File[] ff =new File[2];
...
//       JFileChooser jf = new JFileChooser("e:/develop/theme/My_wc/a.cpp");
//       jf.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);   // 文件目录都可以
//    //   jf.setCurrentDirectory(f);
//       jf.setMultiSelectionEnabled(true);    // 允许多选文件
